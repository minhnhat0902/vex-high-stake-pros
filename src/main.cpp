...
void opcontrol() {
  ...
  // LCD_BTN_RIGHT) >> 0); // Prints status of the emulated screen LCDs
  ...
  // joystick 	left_mg.move(dir - turn);                      // Sets left
  // motor voltage 	right_mg.move(dir + turn);                     // Sets
  // right motor voltage 	pros::delay(20); // Run for 20 ms then update
  // }
